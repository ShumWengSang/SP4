...
void CGamePlayState::Init()
{
	...
	theGrid->temp[2][0].Seeded(CPlayState::Instance()->theHaze.HazeGraph[DayNumber * DayTime] * 1000);//CPlayState::Instance()->theHaze.HazeGraph[DayNumber * DayTime]
	theGrid->temp[3][0].Seeded(CPlayState::Instance()->theHaze.HazeGraph[DayNumber * DayTime] * 1000);
